...
export const option: OptionObject = {
  ...
  Operating_System_PC: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Без ОС", en: "No OS" }, query_value: "bez_os" },
  ...
  Operating_System_MP: {
    ...
    select: [
      ...
      { name: { ua: "Інша", en: "Other" }, query_value: "insha" },
    ],
    multiple: false,
  },
  CPU_PC: {
  ...
  RAM: {
    ...
    select: [
      ...
      { name: { ua: "До 3 ГБ", en: "Up to 3 GB" }, query_value: "do_3_hb" },
      { name: { ua: "4 ГБ", en: "4 GB" }, query_value: "4_hb" },
      { name: { ua: "6 ГБ", en: "6 GB" }, query_value: "6_hb" },
      { name: { ua: "8 ГБ", en: "8 GB" }, query_value: "8_hb" },
      { name: { ua: "10 ГБ", en: "10 GB" }, query_value: "10_hb" },
      { name: { ua: "12 ГБ", en: "12 GB" }, query_value: "12_hb" },
      { name: { ua: "16 ГБ", en: "16 GB" }, query_value: "16_hb" },
      { name: { ua: "24 ГБ", en: "24 GB" }, query_value: "24_hb" },
      { name: { ua: "32 ГБ", en: "32 GB" }, query_value: "32_hb" },
      { name: { ua: "48 ГБ", en: "48 GB" }, query_value: "48_hb" },
      { name: { ua: "64 ГБ", en: "64 GB" }, query_value: "64_hb" },
    ],
    multiple: false,
  },
  Color: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Інші", en: "Other" }, query_value: "inshi" },
      { name: { ua: "Білий", en: "White" }, query_value: "bilyy" },
      { name: { ua: "Жовтий", en: "Yellow" }, query_value: "zhovtyy" },
      { name: { ua: "Зелений", en: "Green" }, query_value: "zelenyy" },
      { name: { ua: "Золотий", en: "Gold" }, query_value: "zolotyy" },
      { name: { ua: "Рожевий", en: "Pink" }, query_value: "rozhevyy" },
      { name: { ua: "Синій", en: "Blue" }, query_value: "syniy" },
      { name: { ua: "Сріблястий", en: "Silver" }, query_value: "sriblyastyy" },
      { name: { ua: "Сірий", en: "Grey" }, query_value: "siryy" },
      { name: { ua: "Фіолетовий", en: "Purple" }, query_value: "fioletovyy" },
      { name: { ua: "Червоний", en: "Red" }, query_value: "chervonyy" },
      { name: { ua: "Чорний", en: "Black" }, query_value: "chornyy" },
      { name: { ua: "Бежевий", en: "Beige" }, query_value: "bezhevyy" },
      { name: { ua: "Блакитний", en: "Blue" }, query_value: "blakytnyy" },
      {
        name: { ua: "Біло-золотистий", en: "White and gold" },
        query_value: "bilo_zolotystyy",
      },
      {
        name: { ua: "Жовтогарячий", en: "Orange" },
        query_value: "zhovtoharyachyy",
      },
      { name: { ua: "Золотистий", en: "Gold" }, query_value: "zolotystyy" },
      { name: { ua: "Камуфляж", en: "Camouflage" }, query_value: "kamuflyazh" },
      {
  ...
  New_Used: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Новий", en: "New" }, query_value: "novyy" },
      { name: { ua: "Вживаний", en: "Used" }, query_value: "vzhyvanyy" },
    ],
    multiple: false,
  },
  Guarantee: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Немає", en: "None" }, query_value: "nemaye" },
      { name: { ua: "1 рік", en: "1 year" }, query_value: "1_rik" },
      { name: { ua: "2 роки", en: "2 years" }, query_value: "2_roky" },
    ],
    multiple: false,
  },
  Size_SSD: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "128 ГБ", en: "128 GB" }, query_value: "128_hb" },
      { name: { ua: "160 ГБ", en: "160 GB" }, query_value: "160_hb" },
      { name: { ua: "180 ГБ", en: "180 GB" }, query_value: "180_hb" },
      { name: { ua: "200 ГБ", en: "200 GB" }, query_value: "200_hb" },
      { name: { ua: "240 ГБ", en: "240 GB" }, query_value: "240_hb" },
      { name: { ua: "250 ГБ", en: "250 GB" }, query_value: "250_hb" },
      { name: { ua: "256 ГБ", en: "256 GB" }, query_value: "256_hb" },
      { name: { ua: "320 ГБ", en: "320 GB" }, query_value: "320_hb" },
      { name: { ua: "400 ГБ", en: "400 GB" }, query_value: "400_hb" },
      { name: { ua: "480 ГБ", en: "480 GB" }, query_value: "480_hb" },
      { name: { ua: "500 ГБ", en: "500 GB" }, query_value: "500_hb" },
      { name: { ua: "512 ГБ", en: "512 GB" }, query_value: "512_hb" },
  ...
  Screen_Refresh_Rate: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "30 ГЦ", en: "30 Hz" }, query_value: "30_hts" },
      { name: { ua: "60 ГЦ", en: "60 Hz" }, query_value: "60_hts" },
      { name: { ua: "90 ГЦ", en: "90 Hz" }, query_value: "90_hts" },
      { name: { ua: "120 ГЦ", en: "120 Hz" }, query_value: "120_hts" },
      { name: { ua: "144 ГЦ", en: "144 Hz" }, query_value: "144_hts" },
      { name: { ua: "165 ГЦ", en: "165 Hz" }, query_value: "165_hts" },
    ],
    multiple: false,
  },
  Guard: {
  ...
  Body_Material: {
    ...
    select: [
      ...
      { name: { ua: "Пластик", en: "Plastic" }, query_value: "plastyk" },
      { name: { ua: "Скло", en: "Glass" }, query_value: "sklo" },
      { name: { ua: "Інший", en: "Other" }, query_value: "inshyy" },
    ],
    multiple: true,
  },
  Made_in: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Індія", en: "India" }, query_value: "indiya" },
      { name: { ua: "В'єтнам", en: "Vietnam" }, query_value: "v_yetnam" },
      { name: { ua: "Китай", en: "China" }, query_value: "kytay" },
      { name: { ua: "Тайвань", en: "Taiwan" }, query_value: "tayvan'" },
      { name: { ua: "Мексика", en: "Mexico" }, query_value: "meksyka" },
      { name: { ua: "Німеччина", en: "Germany" }, query_value: "nimechchyna" },
      { name: { ua: "Польща", en: "Poland" }, query_value: "pol'shcha" },
      { name: { ua: "Румунія", en: "Romania" }, query_value: "rumuniya" },
      { name: { ua: "США", en: "USA" }, query_value: "ssha" },
      {
        name: { ua: "Словаччина", en: "Slovakia" },
        query_value: "slovachchyna",
      },
      { name: { ua: "Таїланд", en: "Thailand" }, query_value: "tayiland" },
      { name: { ua: "Туреччина", en: "Turkey" }, query_value: "turechchyna" },
      { name: { ua: "Угорщина", en: "Hungary" }, query_value: "uhorshchyna" },
      { name: { ua: "Україна", en: "Ukraine" }, query_value: "ukrayina" },
      { name: { ua: "Японія", en: "Japan" }, query_value: "yaponiya" },
    ],
    multiple: false,
  },
  Communication: {
  ...
  Memory_Capacity: {
    ...
    select: [
      ...
      { name: { ua: "2 ГБ", en: "2 GB" }, query_value: "2_hb" },
      { name: { ua: "3 ГБ", en: "3 GB" }, query_value: "3_hb" },
      { name: { ua: "4 ГБ", en: "4 GB" }, query_value: "4_hb" },
      { name: { ua: "5 ГБ", en: "5GB" }, query_value: "5_hb" },
      { name: { ua: "6 ГБ", en: "6 GB" }, query_value: "6_hb" },
      { name: { ua: "8 ГБ", en: "8 GB" }, query_value: "8_hb" },
      { name: { ua: "10 ГБ", en: "10 GB" }, query_value: "10_hb" },
      { name: { ua: "11 ГБ", en: "11 GB" }, query_value: "11_hb" },
      { name: { ua: "12 ГБ", en: "12 GB" }, query_value: "12_hb" },
      { name: { ua: "16 ГБ", en: "16 GB" }, query_value: "16_hb" },
      { name: { ua: "20 ГБ", en: "20 GB" }, query_value: "20_hb" },
      { name: { ua: "24 ГБ", en: "24 GB" }, query_value: "24_hb" },
      { name: { ua: "36 ГБ", en: "36 GB" }, query_value: "36_hb" },
      { name: { ua: "48 ГБ", en: "48 GB" }, query_value: "48_hb" },
      { name: { ua: "64 ГБ", en: "64 GB" }, query_value: "64_hb" },
    ],
    multiple: false,
  ...
  Memory_Bus_Bit_Size: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "32 біт", en: "32 bits" }, query_value: "32_bit" },
      { name: { ua: "64 біт", en: "64 bits" }, query_value: "64_bit" },
      { name: { ua: "96 бітів", en: "96 bits" }, query_value: "96_bitiv" },
      { name: { ua: "128 біт", en: "128 bits" }, query_value: "128_bit" },
      { name: { ua: "160 біт", en: "160 bits" }, query_value: "160_bit" },
      { name: { ua: "192 біт", en: "192 bits" }, query_value: "192_bit" },
      { name: { ua: "256 біт", en: "256 bits" }, query_value: "256_bit" },
      { name: { ua: "320 біт", en: "320 bits" }, query_value: "320_bit" },
      { name: { ua: "352 біт", en: "352 bits" }, query_value: "352_bit" },
      { name: { ua: "384 біт", en: "384 bits" }, query_value: "384_bit" },
      { name: { ua: "512 біт", en: "512 bits" }, query_value: "512_bit" },
      { name: { ua: "589 біт", en: "589 bits" }, query_value: "589_bit" },
      { name: { ua: "1024 біт", en: "1024 bits" }, query_value: "1024_bit" },
      { name: { ua: "2048 біт", en: "2048 bits" }, query_value: "2048_bit" },
      { name: { ua: "4096 біт", en: "4096 bits" }, query_value: "4096_bit" },
    ],
    multiple: false,
  },
  ...
  Appointment: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Ігрові", en: "Gaming" }, query_value: "ihrovi" },
      {
        name: { ua: "Для майнінгу", en: "For mining" },
        query_value: "dlya_mayninhu",
      },
      { name: { ua: "Звичайні", en: "Regular" }, query_value: "zvychayni" },
      {
  ...
  Form_Factor_Videocards: {
    ...
    select: [
      ...
      { name: { ua: "Зовнішня", en: "External" }, query_value: "zovnishnya" },
  ...
  Additional_Power_Supply: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Немає", en: "No" }, query_value: "nemaye" },
  ...
  Cooling_System_Type: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Активна", en: "Active" }, query_value: "aktyvna" },
      {
        name: { ua: "Водяне охолодження", en: "Water cooling" },
        query_value: "vodyane_okholodzhennya",
      },
      { name: { ua: "Пасивна", en: "Passive" }, query_value: "pasyvna" },
    ],
    multiple: false,
  },
  Graphic_Chip: {
  ...
  Storage_Type: {
    ...
    select: [
      {
        name: { ua: "Внутрішній", en: "Internal" },
        query_value: "vnutrishniy",
      },
      { name: { ua: "Зовнішній", en: "External" }, query_value: "zovnishniy" },
    ],
    multiple: false,
  },
  Appointment_Storage: {
  ...
  CPU_Clock_Speed: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "2.0 ГГц", en: "2.0 GHz" }, query_value: "2.0_hhts" },
      { name: { ua: "2.1 ГГц", en: "2.1 GHz" }, query_value: "2.1_hhts" },
      { name: { ua: "2.2 ГГц", en: "2.2 GHz" }, query_value: "2.2_hhts" },
      { name: { ua: "2.3 ГГц", en: "2.3 GHz" }, query_value: "2.3_hhts" },
      { name: { ua: "2.4 ГГц", en: "2.4 GHz" }, query_value: "2.4_hhts" },
      { name: { ua: "2.5 ГГц", en: "2.5 GHz" }, query_value: "2.5_hhts" },
      { name: { ua: "2.6 ГГц", en: "2.6 GHz" }, query_value: "2.6_hhts" },
      { name: { ua: "2.7 ГГц", en: "2.7 GHz" }, query_value: "2.7_hhts" },
      { name: { ua: "2.8 ГГц", en: "2.8 GHz" }, query_value: "2.8_hhts" },
      { name: { ua: "2.9 ГГц", en: "2.9 GHz" }, query_value: "2.9_hhts" },
      { name: { ua: "3.0 ГГц", en: "3.0 GHz" }, query_value: "3.0_hhts" },
    ],
    multiple: false,
  },
  ...
  RAM_Memory_Size: {
    ...
    select: [
      ...
      { name: { ua: "256 МБ", en: "256 MB" }, query_value: "256_mb" },
      { name: { ua: "512 МБ", en: "512 MB" }, query_value: "512_mb" },
      { name: { ua: "1 ГБ", en: "1 GB" }, query_value: "1_hb" },
      { name: { ua: "2 ГБ", en: "2 GB" }, query_value: "2_hb" },
      { name: { ua: "4 ГБ", en: "4 GB" }, query_value: "4_hb" },
      { name: { ua: "6 ГБ", en: "6 GB" }, query_value: "6_hb" },
      { name: { ua: "8 ГБ", en: "8 GB" }, query_value: "8_hb" },
  ...
  Memory_Frequency: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "133 МГц", en: "133 МHz" }, query_value: "133_mhts" },
      { name: { ua: "300 МГц", en: "300 МHz" }, query_value: "300_mhts" },
      { name: { ua: "333 МГц", en: "333 МHz" }, query_value: "333_mhts" },
      { name: { ua: "400 МГц", en: "400 МHz" }, query_value: "400_mhts" },
      { name: { ua: "533 МГц", en: "533 МHz" }, query_value: "533_mhts" },
      { name: { ua: "667 МГц", en: "667 МHz" }, query_value: "667_mhts" },
      { name: { ua: "800 МГц", en: "800 МHz" }, query_value: "800_mhts" },
      { name: { ua: "900 МГц", en: "900 МHz" }, query_value: "900_mhts" },
      { name: { ua: "1000 МГц", en: "1000 МHz" }, query_value: "1000_mhts" },
      { name: { ua: "1066 МГц", en: "1066 МHz" }, query_value: "1066_mhts" },
      { name: { ua: "1067 МГц", en: "1067 МHz" }, query_value: "1067_mhts" },
      { name: { ua: "1333 МГц", en: "1333 МHz" }, query_value: "1333_mhts" },
      { name: { ua: "1600 МГц", en: "1600 МHz" }, query_value: "1600_mhts" },
      { name: { ua: "1800 МГц", en: "1800 МHz" }, query_value: "1800_mhts" },
      { name: { ua: "1866 МГц", en: "1866 МHz" }, query_value: "1866_mhts" },
      { name: { ua: "2000 МГц", en: "2000 МHz" }, query_value: "2000_mhts" },
      { name: { ua: "2133 МГц", en: "2133 МHz" }, query_value: "2133_mhts" },
      { name: { ua: "2400 МГц", en: "2400 МHz" }, query_value: "2400_mhts" },
      { name: { ua: "2666 МГц", en: "2666 МHz" }, query_value: "2666_mhts" },
      { name: { ua: "2800 МГц", en: "2800 МHz" }, query_value: "2800_mhts" },
      { name: { ua: "2933 МГц", en: "2933 МHz" }, query_value: "2933_mhts" },
      { name: { ua: "3000 МГц", en: "3000 МHz" }, query_value: "3000_mhts" },
      { name: { ua: "3200 МГц", en: "3200 МHz" }, query_value: "3200_mhts" },
      { name: { ua: "3333 МГц", en: "3333 МHz" }, query_value: "3333_mhts" },
      { name: { ua: "3400 МГц", en: "3400 МHz" }, query_value: "3400_mhts" },
      { name: { ua: "3466 МГц", en: "3466 МHz" }, query_value: "3466_mhts" },
      { name: { ua: "3600 МГц", en: "3600 МHz" }, query_value: "3600_mhts" },
      { name: { ua: "3733 МГц", en: "3733 МHz" }, query_value: "3733_mhts" },
      { name: { ua: "3866 МГц", en: "3866 МHz" }, query_value: "3866_mhts" },
      { name: { ua: "4000 МГц", en: "4000 МHz" }, query_value: "4000_mhts" },
      { name: { ua: "4133 МГц", en: "4133 МHz" }, query_value: "4133_mhts" },
      { name: { ua: "4266 МГц", en: "4266 МHz" }, query_value: "4266_mhts" },
      { name: { ua: "4333 МГц", en: "4333 МHz" }, query_value: "4333_mhts" },
      { name: { ua: "4400 МГц", en: "4400 МHz" }, query_value: "4400_mhts" },
      { name: { ua: "4600 МГц", en: "4600 МHz" }, query_value: "4600_mhts" },
      { name: { ua: "4800 МГц", en: "4800 МHz" }, query_value: "4800_mhts" },
      { name: { ua: "5000 МГц", en: "5000 МHz" }, query_value: "5000_mhts" },
      { name: { ua: "5133 МГц", en: "5133 МHz" }, query_value: "5133_mhts" },
      { name: { ua: "5200 МГц", en: "5200 МHz" }, query_value: "5200_mhts" },
      { name: { ua: "5333 МГц", en: "5333 МHz" }, query_value: "5333_mhts" },
      { name: { ua: "5600 МГц", en: "5600 МHz" }, query_value: "5600_mhts" },
      { name: { ua: "6000 МГц", en: "6000 МHz" }, query_value: "6000_mhts" },
      { name: { ua: "6200 МГц", en: "6200 МHz" }, query_value: "6200_mhts" },
      { name: { ua: "6400 МГц", en: "6400 МHz" }, query_value: "6400_mhts" },
      { name: { ua: "7200 МГц", en: "7200 МHz" }, query_value: "7200_mhts" },
      { name: { ua: "7600 МГц", en: "7600 МHz" }, query_value: "7600_mhts" },
    ],
    multiple: false,
  },
  Number_of_Slats: {
  ...
  PCI_Express_x16: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "1 шт", en: "1 pcs" }, query_value: "1_sht" },
      { name: { ua: "2 шт", en: "2 pcs" }, query_value: "2_sht" },
      { name: { ua: "3 шт", en: "3 pcs" }, query_value: "3_sht" },
      { name: { ua: "4 шт", en: "4 pcs" }, query_value: "4_sht" },
      { name: { ua: "5 шт", en: "5 pcs" }, query_value: "5_sht" },
      { name: { ua: "6 шт", en: "6 pcs" }, query_value: "6_sht" },
      { name: { ua: "7 шт", en: "7 pcs" }, query_value: "7_sht" },
      { name: { ua: "8 шт", en: "8 pcs" }, query_value: "8_sht" },
      { name: { ua: "9 шт", en: "9 pcs" }, query_value: "9_sht" },
      { name: { ua: "10 шт", en: "10 pcs" }, query_value: "10_sht" },
      { name: { ua: "11 шт", en: "11 pcs" }, query_value: "11_sht" },
      { name: { ua: "12 шт", en: "12 pcs" }, query_value: "12_sht" },
      {
        name: {
  ...
  Special_Properties: {
    ...
    select: [
      ...
      { name: { ua: "Підсвітка", en: "Backlight" }, query_value: "pidsvitka" },
    ],
    multiple: true,
  },
  Form_Factor_PSU: {
  ...
  PSU_Type: {
    ...
    select: [
      ...
      { name: { ua: "Зовнішній", en: "External" }, query_value: "zovnishniy" },
      {
        name: { ua: "Комп'ютерний", en: "Computer" },
        query_value: "komp_yuternyy",
      },
      { name: { ua: "Серверний", en: "Server" }, query_value: "servernyy" },
    ],
    multiple: true,
  },
  Maximum_Noise_Level: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "До 18", en: "Up to 18" }, query_value: "do_18" },
  ...
  PSU_Location: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Верхнє", en: "Top" }, query_value: "verkhnye" },
      { name: { ua: "Нижнє", en: "Bottom" }, query_value: "nyzhnye" },
    ],
    multiple: false,
  },
  ...
  View: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Відкритий", en: "Open" }, query_value: "vidkrytyy" },
      { name: { ua: "Геймерський", en: "Gamer" }, query_value: "heymers'kyy" },
      {
        name: { ua: "Для майнінгу", en: "For mining" },
        query_value: "dlya_mayninhu",
      },
      { name: { ua: "Звичайний", en: "Normal" }, query_value: "zvychaynyy" },
      {
  ...
  Material: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Акрил", en: "Acrylic" }, query_value: "akryl" },
      { name: { ua: "Алюміній", en: "Aluminium" }, query_value: "alyuminiy" },
      { name: { ua: "Гума", en: "Rubber" }, query_value: "huma" },
      {
      ...
      { name: { ua: "Метал", en: "Metal" }, query_value: "metal" },
      { name: { ua: "Пластик", en: "Plastic" }, query_value: "plastyk" },
      { name: { ua: "Пластмаса", en: "Plastic" }, query_value: "plastmasa" },
      { name: { ua: "Сталь", en: "Steel" }, query_value: "stal'" },
    ],
    multiple: false,
  },
  Installation_Method: {
    ...
    select: [
      {
        name: { ua: "Вертикальний", en: "Vertical" },
  ...
  Appointment_Coolers: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Для SSD", en: "For SSDs" }, query_value: "dlya_ssd" },
      {
  ...
  View_Coolers: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Вентилятори", en: "Fans" }, query_value: "ventylyatory" },
      {
        name: {
      ...
      { name: { ua: "Кулери", en: "Coolers" }, query_value: "kulery" },
      {
        name: { ua: "Пилові фільтри", en: "Dust filters" },
        query_value: "pylovi_fil'try",
      },
      { name: { ua: "Радіатори", en: "Radiators" }, query_value: "radiatory" },
      {
  ...
  Backlight: {
    ...
    select: [
      ...
      { name: { ua: "Блакитний", en: "Blue" }, query_value: "blakytnyy" },
      { name: { ua: "Білий", en: "White" }, query_value: "bilyy" },
      { name: { ua: "Бірюзовий", en: "Turquoise" }, query_value: "biryuzovyy" },
      { name: { ua: "Жовтий", en: "Yellow" }, query_value: "zhovtyy" },
      {
        name: { ua: "Жовтогарячий", en: "Orange" },
        query_value: "zhovtoharyachyy",
  ...
  Cooling_Type: {
    ...
    html_element: "select",
    select: [
      { name: { ua: "Активне", en: "Active" }, query_value: "aktyvne" },
      { name: { ua: "Пасивне", en: "Passive" }, query_value: "pasyvne" },
    ],
    multiple: false,
  },
  Construction: {
    ...
    select: [
      ...
      { name: { ua: "Баштова", en: "Tower" }, query_value: "bashtova" },
    ],
    multiple: false,
  },
  Component_CBA: {
    ...
    select: [
      {
        ...
        query_value: "vodobloky",
      },
      { name: { ua: "Кріплення", en: "Fasteners" }, query_value: "kriplennya" },
      { name: { ua: "Помпи", en: "Pumps" }, query_value: "pompy" },
      { name: { ua: "Радіатори", en: "Radiators" }, query_value: "radiatory" },
      { name: { ua: "Резервуари", en: "Tanks" }, query_value: "rezervuary" },
      { name: { ua: "Термінали", en: "Terminals" }, query_value: "terminaly" },
      {
        name: { ua: "Трубки і шланги", en: "Tubes and hoses" },
        query_value: "trubky_i_shlanhy",
      },
      { name: { ua: "Фітинги", en: "Fittings" }, query_value: "fitynhy" },
      {
